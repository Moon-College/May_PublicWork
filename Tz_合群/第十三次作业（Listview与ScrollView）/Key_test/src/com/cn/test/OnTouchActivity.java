...
/**
 * Created on 2015年6月18日上午9:05:46 OnTouchActivity.java<br/>
...
public class OnTouchActivity extends Activity implements OnTouchListener,
	...
	private void initData() {
		for (int i = 0; i < 50; i++) {
			...
			map.put("title", "第：" + i + "个text");
			maps.add(map);
		}

		adapter = new SimpleAdapter(OnTouchActivity.this, maps, R.layout.item,
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		if (adapter.getCount() == lastposition
