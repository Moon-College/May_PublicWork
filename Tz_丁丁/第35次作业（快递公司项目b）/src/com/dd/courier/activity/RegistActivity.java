...
import com.dd.courier.bean.request.RequestCourierRegister;
...
import com.dd.courier.fragment.RegistFragmentFirst;
import com.dd.courier.fragment.RegistFragmentSecond;
	...
	public void onClick(View v) {
		...
		if(step == 0){
			...
			if(check.checkAge(age)&&check.checkName(name)&&check.checkUserName(userName)&&check.isMobileNO(phone)
				...
				Toast.makeText(this, check.getCheckText(), 1000).show();
			}
			}else{
				//未通过正则
