...
import com.tz.asy.utils.BitmapUtils;
...
public class RegistFragmentSecond extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		//fragment数据缓存
		if(faceImage!=null){
			img_faceImage.setImageBitmap(BitmapUtils.getScaleBitmapByPath(faceImage, getActivity()));
		}
		if(backImage!=null){
			img_backImage.setImageBitmap(BitmapUtils.getScaleBitmapByPath(faceImage, getActivity()));
		}
		if(licenseImage!=null){
			img_licenseImage.setImageBitmap(BitmapUtils.getScaleBitmapByPath(faceImage, getActivity()));
		}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case MyConstants.PHOTO_CDRD_REAR_DATA:
			...
			Bitmap bitmap_back = BitmapUtils.getScaleBitmapByPath(backImage, getActivity());
			img_backImage.setImageBitmap(bitmap_back);
			break;
		case MyConstants.PHOTO_CDRD_WITH_DATA:
			...
			Bitmap bitmap_license = BitmapUtils.getScaleBitmapByPath(licenseImage, getActivity());
			img_licenseImage.setImageBitmap(bitmap_license);
			break;
		default:
			break;
		}
